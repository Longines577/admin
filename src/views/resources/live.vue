  ...
  <div class="table">
    ...
    <div class="container">
      ...
      <el-form :inline="true" :model="filters">
        <el-form-item label="名称">
          <el-input v-model="filters.className" placeholder="请输入名称" size="small" clearable></el-input>
        </el-form-item>
      ...
      >
        ...
        <el-table-column align="center" prop="className" label="名称"></el-table-column>
    ...
    >
      <el-form :model="editForm" label-width="80px" ref="editForm">
        ...
        >
          <el-input v-model="editForm.className" placeholder="请输入名称" size="small" clearable></el-input>
        </el-form-item>
        <el-form-item
          label="联系人"
          prop="linkman"
        ...
        >
          <el-input v-model="editForm.linkman" placeholder="请输入联系人" size="small" clearable></el-input>
        </el-form-item>
        <el-form-item
          label="联系电话"
          prop="phone"
        ...
        >
          <el-input v-model="editForm.phone" placeholder="请输入联系人电话" size="small" clearable></el-input>
        </el-form-item>
        <el-form-item
          label="备注"
          prop="remarks"
...
import { modifyStatusliveRoom } from "../../api/api";
export default {
  mixins: [listMixin],
  data() {
    return {
      ...
      apiName: "system/api/liveRoom/listLiveRoom",
      addName: "system/api/liveRoom/addLiveRoom",
      updateName: "system/api/liveRoom/updateLiveRoom",
      delName: "system/api/liveRoom/delLiveRoom",
      editForm: {},
      loading: false,
      users: [],
      total: 0,
  ...
  methods: {
    ...
    forbidden(row, index) {
      ...
      modifyStatusliveRoom(params).then(res => {
        if (res.code === 30000) {
          this.$message({
            showClose: true,
            message: "已禁用",
          ...
          this.$message({
            showClose: true,
            message: "system/api/liveRoom/modifyStatus" + "出错",
            type: "warning"
          });
        }
      });
