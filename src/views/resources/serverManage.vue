  ...
  <div class="table">
    ...
    <div class="container">
      ...
      <el-form :inline="true" :model="filters">
        <el-form-item label="服务名称">
          <el-input v-model="filters.serviceName" placeholder="请输入服务名称" size="small" clearable></el-input>
        </el-form-item>
    ...
    >
      <el-form :model="editForm" label-width="80px" ref="editForm">
        ...
        <!-- <el-form-item v-if='!isEdit'  label="科目" prop="subjectId" >
        ...
        >
          <el-input v-model="editForm.serviceName" placeholder="请输入名称" size="small" clearable></el-input>
        </el-form-item>
...
import { serviceManage } from "../../api/api";
export default {
  mixins: [listMixin],
  data() {
    return {
      ...
      apiName: "system/api/serviceManage/listServiceManage",
      addName: "system/api/serviceManage/addServiceManage",
      updateName: "system/api/serviceManage/updateServiceManage",
      delName: "system/api/serviceManage/delServiceManage",
      editForm: {},
      option1: [],
      option2: [],
      option3: [],
    ...
    forbidden(row, index) {
      ...
      serviceManage(params).then(res => {
        if (res.code === 30000) {
          ...
          this.$message({
            showClose: true,
            message: "system/api/serviceManage/modifyStatus" + "出错",
            type: "warning"
          });
        }
      });
