  ...
  <div>
    <el-form :model="editForm" label-width="100px" :inline="true" ref="editForm">
        <el-form-item  label="一级项目" prop="firstName" >
             <el-input v-model="firstName" disabled size="small"></el-input>
        </el-form-item>
        <el-form-item  label="二级项目" prop="secondName" >
           <el-input v-model="secondName" disabled size="small"></el-input>
        </el-form-item>
        ...
        <el-form-item label="促销价" prop="promotionPrice">
            <el-input v-model="editForm.promotionPrice" placeholder="请输入促销价" size="small" clearable></el-input>
        </el-form-item>
        <el-form-item label="优惠价" prop="favourablePrice">
            <el-input v-model="editForm.favourablePrice" placeholder="请输入优惠价" size="small" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item label="班型描述" prop="des">
            <el-input type="textarea"  :rows="2"  v-model="editForm.des" placeholder="请输入班型描述" size="small" clearable></el-input>
        </el-form-item>
    </el-form>
...
export default {
  ...
  data() {
    return {
        ...
        firstName: '',
        secondName: '',
        addName: 'system/api/goods/addGoods',
  ...
  mounted(){
    this.data && (this.firstName = this.data.firstName) 
    && (this.secondName = this.data.secondName) 
    && (this.editForm.seviceDate = this.data.seviceDate)
    && (this.editForm.courseTypes = this.data.type)
    this.getAgree(0)
    this.getAgree(1)
    this.getDepartList()
  },
  methods: {
    ...
    editSubmit(){
        ...
        this.editForm.classId = this.data.id
        this.editForm.firstId = this.data.firstId
        this.editForm.secondId = this.data.secondId
