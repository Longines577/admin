			...
			<el-table class="courseTable" :data="payDetails" border highlight-current-row stripe style="width: 100%;">
				...
				<el-table-column align="center" prop="payStatus" label="支付状态" >
					<template slot-scope="scope">
						<el-button type="text" @click="playPay(scope.row)" v-if="scope.row.payStatus == 0&&scope.row.financeStatus != 2">未支付</el-button>
			...
			<el-table class="courseTable" :data="orderDetails" border highlight-current-row stripe style="width: 100%;">
				...
				<el-table-column align="center" label="操作" width='200'>
					<template slot-scope="scope">
						...
						<el-button type="text" size='mini' v-if="scope.row.realMoney>0&&scope.row.orderStatus!=3&&scope.row.orderStatus!=2&&scope.row.isTransfer!=1" @click="toRefund(scope.row,1)">去退费</el-button>
